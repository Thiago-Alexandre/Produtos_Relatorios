...
from API_Products.controllers.book_controller import *
from unittest import mock, TestCase


class TestBook(TestCase):

    @mock.patch("API_Products.controllers.book_controller")
    @mock.patch("API_Products.controllers.book_controller.book_db")
